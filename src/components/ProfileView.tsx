...
import { Shield, CheckCircle, Mail, Phone, MapPin, BadgeCheck, Clock, LogOut } from 'lucide-react';
...
export default function ProfileView({ currentUser, posts, lang, onLogout }: ProfileViewProps) {
  ...
  return (
    <div className="space-y-8" id="user-profile-view">
      {/* Profile Info Header */}
      <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm border border-slate-200/80 dark:border-slate-700 flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
        ...
        <button 
          onClick={onLogout}
          className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-red-600 hover:text-red-700 bg-red-50 dark:bg-red-950/20 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-xl transition-all border border-red-200/30 dark:border-red-900/40 shadow-sm self-stretch md:self-auto justify-center md:justify-start"
        >
