...
import { Search, SlidersHorizontal, Users, AlertTriangle, ArrowRight, Layers, Sparkles, MapPin, Info, CheckCircle2, ChevronDown, Plus, MessageSquare, ShieldAlert, Trash2, Edit2, X, Check, ShieldCheck, Send } from 'lucide-react';
  ...
  return (
    <div className="space-y-8" id="home-view-container">
      ...
      <div className="space-y-8">
        ...
        {/* Testimonials Widget - Moved below the posts */}
        <div className="bg-gradient-to-br from-slate-50 to-slate-100/50 dark:from-slate-800 dark:to-slate-800/80 p-6 rounded-3xl border border-slate-200/80 dark:border-slate-700 space-y-6 mt-12">
          <div className="flex items-center gap-2.5">
            <div className="p-2 bg-[#6b9661]/15 rounded-xl text-[#6b9661]">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
            See how citizens, grassroot NGOs, and Municipal officers collaborate through CivicLens to resolve municipal hazards in record time.
          </p>

          {/* Testimonial Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {/* Testimonial 1 */}
            <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 space-y-3 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="text-[9px] bg-[#4c6c9a]/10 text-[#4c6c9a] font-bold px-1.5 py-0.5 rounded">
                    Active Citizen (HSR Layout)
                  </span>
                </div>
              </div>
              <p className="text-[11px] text-slate-600 dark:text-slate-300 italic leading-relaxed">
                "CivicLens is a game-changer! I reported a massive asphalt pothole near the central main road. Within 3 days, it got verified and fixed. Exceptional tool!"
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 space-y-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-[11px] text-slate-600 dark:text-slate-300 italic leading-relaxed">
                "The AI clustering and duplicate detection prevent waste. We can now allocate volunteers with 100% precision to plant saplings or clean waste."
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 space-y-3 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="text-[9px] bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 font-bold px-1.5 py-0.5 rounded">
                    Corporation Authority
                  </span>
                </div>
              </div>
              <p className="text-[11px] text-slate-600 dark:text-slate-300 italic leading-relaxed">
                "The real-time coordinate validation and high-precision photos allow BBMP crews to address high-severity streetlamp issues rapidly. Stellar tool for trust!"
              </p>
            </div>
          </div>
        </div>
